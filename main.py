...
async def legal_assistant(query_input: QueryInput):
    try:
        ...
        if query_input.web_search:
        ...
        elif query_input.deep_think:


            response = client.chat.completions.create(
                model="deepseek-ai/DeepSeek-R1",
                messages=[ {"role": "system", "content": """As CaseBud, your legal assistant, you provide precise, practical, and confident guidance while remaining casual and approachable. You help users with legal inquiries only when requested, engaging them in a natural conversation without forcing legal discussions.
            ...
            return {"query": user_query, "response": ai_response, "source": "DeepSeek-R1", "is_doc_gen": doc}
        else:
            response = client.chat.completions.create(
                model="Qwen/Qwen2-VL-72B-Instruct",
                messages=[ {"role": "system", "content": """As CaseBud, your legal assistant, you provide precise, practical, and confident guidance while remaining casual and approachable. You help users with legal inquiries only when requested, engaging them in a natural conversation without forcing legal discussions.
            ...
            return {"query": user_query, "response": ai_response, "source": "Qwen2-VL-72B-Instruct", "is_doc_gen": doc}
